  ...
  },
  {
      ...
      on: {
        ...
        var myPhotoBrowserDark = app.photoBrowser.create({
            photos : [
                'assets/img/status/status-1.jpg',
                'assets/img/status/status-2.jpg',
                'assets/img/status/status-3.jpg',
                'assets/img/status/status-4.jpg',
                'assets/img/status/status-5.jpg',
                'assets/img/status/status-6.jpg',
                'assets/img/status/status-7.jpg',
                'assets/img/status/status-8.jpg',
                'assets/img/status/status-9.jpg',
                'assets/img/status/status-10.jpg',
            ],
            theme: 'dark'
        });
